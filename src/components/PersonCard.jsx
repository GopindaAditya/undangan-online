...
export default function PersonCard({ person, direction }) {
  return (
    ...
    >
      ...
      <span className="px-space-sm py-1 rounded-full bg-surface-elevated text-white font-label-caption text-label-caption uppercase tracking-widest mb-space-xs">
        {person.role}
      </span>
      <h4 className="font-headline-sm text-headline-sm text-white font-semibold tracking-wide">
        {person.fullName}
      </h4>

...
export default function PersonCard({ person, direction }) {
  return (
    ...
    >
      ...
      <span className="px-space-sm py-1 rounded-full bg-surface-elevated text-[#FFD700] font-label-caption text-label-caption uppercase tracking-widest mb-space-xs">
        {person.role}
      </span>
      <h4 className="font-headline-sm text-headline-sm text-[#FFD700] font-semibold tracking-wide">
        {person.fullName}
      </h4>
      ...
      <div className="mt-space-md flex items-center gap-space-2xs text-text-muted text-xs">
        <span className="material-symbols-outlined text-[16px] text-[#FFD700]">location_on</span>

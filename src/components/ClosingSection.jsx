  ...
  return (
    <section className="w-full px-space-md py-space-lg flex flex-col items-center text-center">
      <Reveal className="w-full max-w-sm bg-surface-elevated rounded-xl p-space-lg shadow-xl shadow-black/60 relative">
        <div className="w-12 h-12 rounded-full bg-surface-charcoal mx-auto flex items-center justify-center text-[#FFD700] mb-space-sm shadow-md">
        ...
        <h4 className="font-headline-sm text-headline-sm text-[#FFD700] font-semibold">

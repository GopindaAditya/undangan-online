  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mt-auto pb-space-xl text-center">
        <motion.span
          className="font-label-gold text-label-gold text-white tracking-[0.3em] uppercase drop-shadow-md block"
        ...
        <motion.h1
          className="font-display-hero text-display-hero-mobile mt-2 font-bold text-white tracking-wide leading-none drop-shadow-xl"
